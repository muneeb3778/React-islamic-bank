    ...
    return (
      ...
      <div className='bg-white w-[320px] h-[568px] relative overflow-hidden'>
       ...
       <div className='w-[164px] h-[164px] rounded-[50%] bg-[#FFFFFF] blur-[2px] shadow shadow-[#D4A852] flex justify-center items-center border border-[#D4A852] '>
        ...
        <p className='text-center text-[#6A6A6A] text-[12px]'>Your Request Has Been Sent Successfully</p>
        </div>
       </div>
         <button className='w-[272px] h-[38px] absolute top-[506px] left-[24px] rounded-[8px] border-[#FFFFFF] bg-gray-300 text-white'>One Moment...</button>
